...
void Month::add_users_in_range_to_external_cont(day_t begin_day, day_t end_day, users_unordered_cont_t& ext_users_cont)
{
...
void Month::AddUsersBornAfterGivenDayToExternalCont(day_t day, users_unordered_cont_t& ext_users_cont)
{
    add_users_in_range_to_external_cont(day + 1, MAX_DAYS_IN_MONTH + 1, ext_users_cont);
}

void Month::AddUsersBornOnOrBeforeGivenDayToExternalCont(day_t day, users_unordered_cont_t& ext_users_cont)
{
